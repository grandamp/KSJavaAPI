 ...
 * 
 * $Id: PIVCardHolderFingerprints.java 3 2013-07-23 16:00:13Z grandamp@gmail.com $
 *
...
//TODO: PIVCardHolderFingerprints

/**
 */
public class PIVCardHolderFingerprints {

	// private final static boolean debug = true;

	private byte[] fpo;

	public PIVCardHolderFingerprints() {
		encode();
	}

	/**
	 * Constructor for PIVCardHolderFingerprints.
	 * @param ba byte[]
	 */
	public PIVCardHolderFingerprints(byte[] ba) {
		decode(ba);
		this.fpo = ba;
	}
